...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetStatusRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetStatusResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    ...
    M.json("default", operations.GetStatusResponse$inboundSchema, {
      ctype: "application/problem+json",
      key: "Result",
    }),
