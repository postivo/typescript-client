 ...
 */
export function addressBookContactsRemoveFromGroup(
  client: ClientCore,
  request: operations.RemoveContactFromGroupRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.RemoveContactFromGroupResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RemoveContactFromGroupRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      204,
      operations.RemoveContactFromGroupResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
