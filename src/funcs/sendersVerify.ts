 ...
 */
export function sendersVerify(
  client: ClientCore,
  request: operations.VerifySenderRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.VerifySenderResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.VerifySenderRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/senders/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.VerifySenderResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
    ...
    M.json(
      "default",
      operations.VerifySenderResponse$inboundSchema.optional(),
