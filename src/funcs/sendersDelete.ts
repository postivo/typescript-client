 ...
 */
export function sendersDelete(
  client: ClientCore,
  request: operations.DeleteSenderRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteSenderResponse | undefined,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.DeleteSenderResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
    ...
    M.json(
      "default",
      operations.DeleteSenderResponse$inboundSchema.optional(),
