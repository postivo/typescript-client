 ...
 */
export function shipmentsCancel(
  client: ClientCore,
  request: operations.CancelShipmentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CancelShipmentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CancelShipmentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/shipment/{ids}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CancelShipmentResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    ...
    M.json("default", operations.CancelShipmentResponse$inboundSchema, {
      ctype: "application/problem+json",
      key: "Result",
    }),
