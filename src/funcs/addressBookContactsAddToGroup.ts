 ...
 */
export function addressBookContactsAddToGroup(
  client: ClientCore,
  request: operations.AddContactToGroupRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AddContactToGroupResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddContactToGroupRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/contacts/{id}/group/{group_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.AddContactToGroupResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
    ...
    M.json(
      "default",
      operations.AddContactToGroupResponse$inboundSchema.optional(),
