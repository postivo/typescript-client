 ...
 */
export function addressBookGroupsUpdate(
  client: ClientCore,
  request: operations.UpdateGroupRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateGroupResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateGroupResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    ...
    M.json("default", operations.UpdateGroupResponse$inboundSchema, {
      ctype: "application/problem+json",
      key: "Result",
    }),
