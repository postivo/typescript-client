 ...
 */
export function shipmentsDocuments(
  client: ClientCore,
  request: operations.GetDocumentsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetDocumentsResponse,
...
> {
  ...
  const path = pathToFunc("/shipment/{id}/document/{type}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetDocumentsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    ...
    M.json("default", operations.GetDocumentsResponse$inboundSchema, {
      ctype: "application/problem+json",
      key: "Result",
    }),
