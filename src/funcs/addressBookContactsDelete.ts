 ...
 */
export function addressBookContactsDelete(
  client: ClientCore,
  request: operations.DeleteContactRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteContactResponse | undefined,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.DeleteContactResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
    ...
    M.json(
      "default",
      operations.DeleteContactResponse$inboundSchema.optional(),
