...
export function metadataList(
  ...
  Result<
    operations.ListMetadataResponse,
...
> {
  const path = pathToFunc("/metadata")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListMetadataResponse$inboundSchema),
    ...
    M.json("default", operations.ListMetadataResponse$inboundSchema, {
      ctype: "application/problem+json",
    }),
