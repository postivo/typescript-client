 ...
 */
export function shipmentsPrice(
  client: ClientCore,
  request: models.Shipment,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ShipmentPriceResponse,
...
> {
  ...
  const path = pathToFunc("/shipment/price")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ShipmentPriceResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    ...
    M.json("default", operations.ShipmentPriceResponse$inboundSchema, {
      ctype: "application/problem+json",
      key: "Result",
    }),
