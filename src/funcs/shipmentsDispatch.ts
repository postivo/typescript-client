 ...
 */
export function shipmentsDispatch(
  client: ClientCore,
  request: models.Shipment,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ShipmentDispatchResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => models.Shipment$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/shipment")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ShipmentDispatchResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    ...
    M.json("default", operations.ShipmentDispatchResponse$inboundSchema, {
      ctype: "application/problem+json",
      key: "Result",
    }),
